...
Therefore, if the node $D$ has the \emph{MaxRoutes} limit set, it will
memorise only the first \emph{MaxRoutes} received routes for each node of the
network, while the rest will be disregarded. 
%TODO CONTINUE HERE!!!!!!!!!!
...
%non considerate alcune rotte.  La sua utilita' e'
%quella di far arrivare prima le rotte che hanno la media migliore tra rtt e
%bw. Il suo difetto e' che vengono esclusi i casi estremi.
%
