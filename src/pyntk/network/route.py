...
class Route:
  ...
  def _ip_route_gen_str(self, destination_ip = None, destination_bit = None,
    ...
    if(destination_ip != None):
      if destionation_bit == None:
        logging.error("Invalid ip provided (missing bitmask)")
      else:
  ...
  def _ip_route_add(self, destination_ip, destination_bit, table, net_device, gateway):
    ...
    ipr_str = "ip route add" + self._ip_route_gen_str(destination_ip, destination_bit, Route.protocol, table, net_device, gateway)
    
    # execute ip route
    self._exec_ipr(ipr_str)
  ...
  def _ip_route_delete(self, destination_ip, destination_bit, table = None, net_device = None, gateway = None):
    ...
    # generate the ip route string
    ipr_str = "ip route delete" + self._ip_route_gen_str(destination_ip, destination_bit, Route.protocol, table, net_device, gateway)
  ...
  def _ip_route_flush(self, destination_ip = None, destination_bit = None, table = None, net_device = None, gateway = None):
    ...
    if((destination_ip == None) and (table == None) and (net_device == None) and (destination == None)):
      logging.error("Cannot flush without valid criteria")

    # generate the ip route string
    ipr_str = "ip route flush" + self._ip_route_gen_str(destination_ip, destination_bit, Route.protocol, table, net_device, gateway)
  ...
  def _ip_route_change(self, destination_ip, destination_bit, table = None, net_device = None, gateway = None):
    ...
    # generate the ip route string
    ipr_str = "ip route change" + self._ip_route_gen_str(destination_ip, destination_bit, Route.protocol, table, net_device, gateway)
  ...
  def route_add(self, destination_ip, destination_bit, table, net_device, gateway):
    ...
    self._ip_route_add(destination_ip, destination_bit, table, net_device, gateway)
  ...
  def route_delete(self, destination_ip, destination_bit, table = None, net_device = None, gateway = None):
    ...
    self._ip_route_delete(destination_ip, destination_bit, table, net_device, gateway)
  ...
  def route_flush(self, destination_ip = None, destination_bit = None, table = None, net_device = None, gateway = None):
    ...
    self._ip_route_flush(self, destination_ip, destination_bit, table, net_device, gateway)
  ...
  def route_change(self, destination_ip, destination_bit, table = None, net_device = None, gateway = None):
    ...
    self._ip_route_change(destination_ip, destination_bit, table, net_device, gateway)

  def route_rp_filter_enable(self, net_device):
    """ enable rp filtering on net_device """
    self._route_rp_filter(net_device, True)

  def route_rp_filter_disable(self, net_device):
    """ disable rp filtering on net_device """
    self._route_rp_filter(net_device, False)
    
  def route_ip_forward_enable(self):
    """ enable ip forwarding """
    self._route_ip_forward(True)

  def route_ip_forward_disable(self):
    """ disable ip forwarding """
    self._route_ip_forward(False)

  def route_flush_cache(self):
    """ flush kernel route cache """
    self._proc_route_flush_cache()

  def _route_rp_filter(self, net_device, enable):
    """ enable/disable rp filtering """
    self._proc_route_rp_filter(net_device, enable)
    
  def _route_ip_forward(self, enable):
    """ enable/disable ip forwarding """
    self._proc_ip_forward(enable)

  def _proc_route_rp_filter(self, net_device, enable):
    ...
    # write in /proc
    self._proc_write(proc_path, proc_value)
  
  def _proc_ip_forward(self, enable):
  ...
  def _proc_write(self, proc_path, proc_value):
