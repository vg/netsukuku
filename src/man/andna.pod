...
The ANDNA database is scattered inside all the Netsukuku and in the worst case
...
=head2 MX REGISTRATION and RESOLUTION

It is currently not supported.

=head1 SIGNALS

When the B<SIGHUP> signal is sent to ntkd(8), the F<andna_hostnames> file
