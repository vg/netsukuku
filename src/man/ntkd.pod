...
=item B<-m>, B<--module> I<mod_name [arg1[=value], arg2[=value], ...]>

Forces B<ntkd> to load the specified module. The format of the I<module>
argument is: B<module_name [arg1[=value], arg2[=value], ...]>.
