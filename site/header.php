...
else if (($_GET['ntk'] == "lgn") && ($_GET['act'] == "login"))
	$tpl_main = file_get_contents(PUN_ROOT.'include/template/black.tpl');
else if (($_GET['ntk'] == "rgstr") && ($_GET['act'] == "register"))
	$tpl_main = file_get_contents(PUN_ROOT.'include/template/black.tpl');
else
...
else
{
	...
	if (in_array(basename($_SERVER['PHP_SELF']), array('index.php', 'search.php')))
		$tpl_temp .= "\n\t\t\t".'</ul>'."\n\t\t\t".'<ul class="conr">'."\n\t\t\t\t".'<li><a href="index.php?pag=forum&amp;act=search&amp;action=show_new">'.$lang_common['Show new posts'].'</a></li>'."\n\t\t\t\t".'<li><a href="index.php?pag=forum&amp;act=misc&amp;action=markread">'.$lang_common['Mark all as read'].'</a></li>'."\n\t\t\t".'</ul>'."\n\t\t\t".'<div class="clearer"></div>'."\n\t\t".'</div>';
	else
		$tpl_temp .= "\n\t\t\t".'</ul>'."\n\t\t\t".'<div class="clearer"></div>'."\n\t\t".'</div>';
}
