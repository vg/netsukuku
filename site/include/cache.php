...
function generate_quickjump_cache($group_id = false)
{
	...
	while (list(, $group_id) = @each($groups))
	{
		...
		$output .= "\t\t\t\t".'<form id="qjump" method="get" action="index.php"><input type="hidden" name="pag" value="forum"><input type="hidden" name="act" value="viewforum">'."\n\t\t\t\t\t".'<div><label><?php echo $lang_common[\'Jump to\'] ?>'."\n\n\t\t\t\t\t".'<br /><select name="id" onchange="window.location=(\'index.php?pag=forum&act=viewforum&id=\'+this.options[this.selectedIndex].value)">'."\n";
