<?php
//	header('Location: index2.php?p=userlist');
/***********************************************************************
...
<div class="blockform">
	...
	<div class="box">
	<form id="userlist" method="get" action="index.php">
...
?>
				<tr>
					<td class="tcl"><?php echo '<a href="index.php?pag=forum&amp;act=profile&amp;id='.$user_data['id'].'">'.pun_htmlspecialchars($user_data['username']).'</a>' ?></td>
