...
if (isset($_POST['delete']))
{
	...
	if ($is_topic_post)
	{
		...
		redirect('index.php?pag=forum&amp;act=viewforum&amp;id='.$cur_post['fid'], $lang_delete['Topic del redirect']);
	}
	else
	{
		...
		redirect('index.php?pag=forum&amp;act=viewtopic&amp;id='.$cur_post['tid'], $lang_delete['Post del redirect']);
	}
}
...
<div class="linkst">
	<div class="inbox">
		<ul><li><a href="index.php"><?php echo $lang_common['Index'] ?></a></li><li>&nbsp;&raquo;&nbsp;<a href="index.php?pag=forum&amp;act=viewforum&amp;id=<?php echo $cur_post['fid'] ?>"><?php echo pun_htmlspecialchars($cur_post['forum_name']) ?></a></li><li>&nbsp;&raquo;&nbsp;<?php echo pun_htmlspecialchars($cur_post['subject']) ?></li></ul>
	</div>
</div>
