...
if ($action == 'change_pass')
{
	...
	if (isset($_POST['form_sent']))
	{
		...
		redirect('index.php?pag=forum&act=profile&section=essentials&amp;id='.$id, $lang_profile['Pass updated redirect']);
	}
...
else if ($action == 'upload_avatar' || $action == 'upload_avatar2')
{
	...
	if (isset($_POST['form_sent']))
	{
		...
		redirect('index.php?pag=forum&act=profile&section=personality&amp;id='.$id, $lang_profile['Avatar upload redirect']);
	}
...
else if ($action == 'delete_avatar')
{
	...
	redirect('index.php?pag=forum&act=profile&section=personality&amp;id='.$id, $lang_profile['Avatar deleted redirect']);
}
...
else if (isset($_POST['update_group_membership']))
{
	...
	redirect('index.php?pag=forum&act=profile&section=admin&amp;id='.$id, $lang_profile['Group membership redirect']);
}
...
else if (isset($_POST['update_forums']))
{
	...
	redirect('index.php?pag=forum&act=profile&section=admin&amp;id='.$id, $lang_profile['Update forums redirect']);
}
...
else if (isset($_POST['delete_user']) || isset($_POST['delete_user_comply']))
{
	...
	if (isset($_POST['delete_user_comply']))
	{
		...
		redirect('index.php?pag=forum', $lang_profile['User delete redirect']);
	}
...
else if (isset($_POST['form_sent']))
{
	...
	redirect('index.php?pag=forum&act=profile&section='.$section.'&amp;id='.$id, $lang_profile['Profile redirect']);
}
	...
	($pun_user['g_id'] == PUN_MOD && $user['g_id'] < PUN_GUEST)))
{
	if ($user['email_setting'] == '0' && !$pun_user['is_guest'])
		...
		$email_field = '<a href="index.php?pag=forum&amp;act=misc&amp;email='.$id.'">'.$lang_common['Send e-mail'].'</a>';
	else
	...
	if ($pun_user['g_search'] == '1')
		$posts_field .= (($posts_field != '') ? ' - ' : '').'<a href="index.php?pag=forum&amp;act=search&amp;action=show_user&amp;user_id='.$id.'">'.$lang_profile['Show posts'].'</a>';
...
else
{
	if (!$section || $section == 'essentials')
	{
		if ($pun_user['g_id'] < PUN_GUEST)
		{
			...
			$email_field = '<label><strong>'.$lang_common['E-mail'].'</strong><br /><input type="text" name="req_email" value="'.$user['email'].'" size="40" maxlength="50" /><br /></label><p><a href="index.php?pag=forum&amp;act=misc&amp;email='.$id.'">'.$lang_common['Send e-mail'].'</a></p>'."\n";
		}
		else
		{
			$username_field = '<p>'.$lang_common['Username'].': '.pun_htmlspecialchars($user['username']).'</p>'."\n";
			...
			if ($pun_config['o_regs_verify'] == '1')
				$email_field = '<p>'.$lang_common['E-mail'].': '.$user['email'].'&nbsp;-&nbsp;<a href="index.php?pag=forum&amp;act=profile&amp;action=change_email&amp;id='.$id.'">'.$lang_profile['Change e-mail'].'</a></p>'."\n";
			else
		...
		if ($pun_user['g_id'] == PUN_ADMIN)
			$posts_field = '<label>'.$lang_common['Posts'].'<br /><input type="text" name="num_posts" value="'.$user['num_posts'].'" size="8" maxlength="8" /><br /></label><p><a href="index.php?pag=forum&amp;act=search&amp;action=show_user&amp;user_id='.$id.'">'.$lang_profile['Show posts'].'</a></p>'."\n";
		else if ($pun_config['o_show_post_count'] == '1' || $pun_user['g_id'] < PUN_GUEST)
			$posts_field = '<p>'.$lang_common['Posts'].': '.$user['num_posts'].' - <a href="index.php?pag=forum&amp;act=search&amp;action=show_user&amp;user_id='.$id.'">'.$lang_profile['Show posts'].'</a></p>'."\n";
		else
			$posts_field = '<p><a href="index.php?pag=forum&amp;act=search&amp;action=show_user&amp;user_id='.$id.'">'.$lang_profile['Show posts'].'</a></p>'."\n";
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="profile1" method="post" action="index.php?pag=forum&amp;act=profile&amp;section=essentials&amp;id=<?php echo $id ?>" onsubmit="return process_form(this)">
				<div class="inform">
					<fieldset>
...
<?php if ($pun_user['id'] == $id || $pun_user['g_id'] == PUN_ADMIN || ($user['g_id'] > PUN_MOD && $pun_config['p_mod_change_passwords'] == '1')): ?><p><a href="index.php?pag=forum&amp;act=profile&amp;action=change_pass&amp;id=<?php echo $id ?>"><?php echo $lang_profile['Change pass'] ?></a></p>
<?php endif; ?>					</div>
					</fieldset>
				</div>
				<div class="inform">
...
<?php endif; ?>					</fieldset>
				...
				<p><input type="submit" name="update" value="<?php echo $lang_common['Submit'] ?>" /><?php echo "<br />".$lang_profile['Instructions'] ?></p>
			</form>
		</div>
	</div>
<?php
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="profile2" method="post" action="index.php?pag=forum&amp;act=profile&amp;section=personal&amp;id=<?php echo $id ?>">
				<div class="inform">
					<fieldset>
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="profile3" method="post" action="index.php?pag=forum&amp;act=profile&amp;section=messaging&amp;id=<?php echo $id ?>">
				<div class="inform">
					<fieldset>
...
<?php
	...
	{
		$avatar_field = '<a href="index.php?pag=forum&amp;act=profile&amp;action=upload_avatar&amp;id='.$id.'">'.$lang_profile['Change avatar'].'</a>';
		if ($img_size = @getimagesize($pun_config['o_avatars_dir'].'/'.$id.'.gif'))
			$avatar_format = 'gif';
		else if ($img_size = @getimagesize($pun_config['o_avatars_dir'].'/'.$id.'.jpg'))
			$avatar_format = 'jpg';
			...
			$avatar_field = '<a href="index.php?pag=forum&amp;profile&amp;action=upload_avatar&amp;id='.$id.'">'.$lang_profile['Upload avatar'].'</a>';

		// Display the delete avatar link?
		if ($img_size)
			$avatar_field .= '&nbsp;&nbsp;&nbsp;<a href="index.php?pag=profile&amp;action=delete_avatar&amp;id='.$id.'">'.$lang_profile['Delete avatar'].'</a>';
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="profile4" method="post" action="index.php?pag=forum&amp;act=profile&amp;section=personality&amp;id=<?php echo $id ?>">
...
<?php endif; ?>				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							...
							<ul class="bblinks">
								<li><a href="index.php?pag=forum&amp;act=help#bbcode" onclick="window.open(this.href); return false;"><?php echo $lang_common['BBCode'] ?></a>: <?php echo ($pun_config['p_sig_bbcode'] == '1') ? $lang_common['on'] : $lang_common['off']; ?></li>
								<li><a href="index.php?pag=forum&amp;act=help#img" onclick="window.open(this.href); return false;"><?php echo $lang_common['img tag'] ?></a>: <?php echo ($pun_config['p_sig_img_tag'] == '1') ? $lang_common['on'] : $lang_common['off']; ?></li>
								<li><a href="index.php?pag=forum&amp;act=help#smilies" onclick="window.open(this.href); return false;"><?php echo $lang_common['Smilies'] ?></a>: <?php echo ($pun_config['o_smilies_sig'] == '1') ? $lang_common['on'] : $lang_common['off']; ?></li>
							</ul>
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="profile5" method="post" action="index.php?pag=forum&amp;act=profile&amp;section=display&amp;id=<?php echo $id ?>">
				<div><input type="hidden" name="form_sent" value="1" /></div>
<?php
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="profile6" method="post" action="index.php?pag=forum&amp;act=profile&amp;section=privacy&amp;id=<?php echo $id ?>">
				<div class="inform">
					<fieldset>
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="profile7" method="post" action="index.php?pag=forum&amp;act=profile&amp;section=admin&amp;id=<?php echo $id ?>&amp;action=foo">
				<div class="inform">
				<input type="hidden" name="form_sent" value="1" />
					<fieldset>
<?php
