<?php
$select_provinces = "
<select style=\"width: 120px; font-size: 10px;\" name=\"prn\" onchange=\"this.form.submit();\""; 

if ($_GET['prn'] == 'ee') {
	$select_provinces .= " disabled=\"true\">
	<option selected value=ee>Outside Italy</option>
	</select>";
} else {
	$select_provinces .= ">
	<option selected value=\"\">Cities of the future</option>
	<option value=\"\">-------</option>
	<option value=ee>Outside Italy</option>
	<option value=\"\">-------</option>
	...
	<option value=vt>Viterbo</option>
        <option value=za>Zara</option>
	</select>";
}

$states_select = "<select style=\"width: 120px; font-size: 10px;\" name=\"cns\" onchange=\"this.form.submit();\" >
