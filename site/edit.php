...
if (isset($_POST['form_sent']))
{
	...
	if (empty($errors) && !isset($_POST['preview']))
	{
		...
		redirect('index.php?pag=forum&act=viewtopic&pid='.$id.'#p'.$id, $lang_post['Edit redirect']);
	}
}
...
<div class="linkst">
	<div class="inbox">
		<ul><li><a href="index.php?pag=forum"><?php echo $lang_common['Index'] ?></a></li><li>&nbsp;&raquo;&nbsp;<a href="index.php?pag=forum&amp;act=viewforum&amp;id=<?php echo $cur_post['fid'] ?>"><?php echo pun_htmlspecialchars($cur_post['forum_name']) ?></a></li><li>&nbsp;&raquo;&nbsp;<?php echo pun_htmlspecialchars($cur_post['subject']) ?></li></ul>
	</div>
</div>
...
<div class="blockform">
	...
	<div class="box">
		<form id="edit" method="post" action="index.php?pag=forum&amp;act=edit&amp;id=<?php echo $id ?>&amp;action=edit" onsubmit="return process_form(this)">
			<div class="inform">
				<fieldset>
