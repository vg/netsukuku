...
if (isset($_GET['cancel']))
	redirect('index.php?pag=forum', $lang_register['Reg cancel redirect']);
...
else if (isset($_POST['form_sent']))
{
	...
	redirect('index.php?pag=forum', $lang_register['Reg complete']);
}
...
<div class="blockform">
	...
	<div class="box">
		<form id="register" method="post" action="index.php?pag=forum&act=register&action=register" onsubmit="this.register.disabled=true;if(process_form(this)){return true;}else{this.register.disabled=false;return false;}">
			<div class="inform">
				<div class="forminfo">
