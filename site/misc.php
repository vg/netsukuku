...
else if ($action == 'markread')
{
	...
	redirect('index.php?pag=forum', $lang_misc['Mark read redirect']);
}
...
else if (isset($_GET['report']))
{
	...
	if (isset($_POST['form_sent']))
	{
		...
		redirect('index.php?pag=forum&act=viewtopic&pid='.$post_id.'#p'.$post_id, $lang_misc['Report redirect']);
	}
...
<div class="blockform">
	...
	<div class="box">
		<form id="report" method="post" action="index.php?pag=forum&amp;act=misc&amp;report=<?php echo $post_id ?>" onsubmit="this.submit.disabled=true;if(process_form(this)){return true;}else{this.submit.disabled=false;return false;}">
			<div class="inform">
				<fieldset>
...
else if (isset($_GET['subscribe']))
{
	...
	redirect('index.php?pag=forum&act=viewtopic&id='.$topic_id, $lang_misc['Subscribe redirect']);
}
...
else if (isset($_GET['unsubscribe']))
{
	...
	redirect('index.php?pag=forum&act=viewtopic&id='.$topic_id, $lang_misc['Unsubscribe redirect']);
}
