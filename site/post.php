...
if (isset($_POST['form_sent']))
{
	...
	if (empty($errors) && !isset($_POST['preview']))
	{
		...
		redirect('index.php?pag=forum&act=viewtopic&pid='.$new_pid.'#p'.$new_pid, $lang_post['Post redirect']);
	}
}
...
if ($tid)
{
	...
	$form = '<form id="post" method="post" action="index.php?pag=forum&amp;act=post&amp;action=post&amp;tid='.$tid.'" onsubmit="this.submit.disabled=true;if(process_form(this)){return true;}else{this.submit.disabled=false;return false;}">';
	...
	$forum_name = '<a href="index.php?pag=forum&amp;act=viewforum&amp;id='.$cur_posting['id'].'">'.pun_htmlspecialchars($cur_posting['forum_name']).'</a>';
}
...
else if ($fid)
{
	...
	$form = '<form id="post" method="post" action="index.php?pag=forum&amp;act=post&amp;action=post&amp;fid='.$fid.'" onsubmit="return process_form(this)">';
...
<div class="linkst">
	<div class="inbox">
		<ul><li><a href="index.php?pag=forum"><?php echo $lang_common['Index'] ?></a></li><li>&nbsp;&raquo;&nbsp;<?php echo $forum_name ?><?php if (isset($cur_posting['subject'])) echo '</li><li>&nbsp;&raquo;&nbsp;'.pun_htmlspecialchars($cur_posting['subject']) ?></li></ul>
	</div>
</div>
