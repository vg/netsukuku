...
class Hook(object):
    ...
    def call_communicating_vessels_udp(self, neigh):
        ...
        netid = neigh.netid
        return rpc.UDP_call(nip, netid, devs, 'hook.communicating_vessels_udp')

    def communicating_vessels_udp(self, _rpc_caller, caller_id, callee_nip, callee_netid):
            ...
            if we_are_alone:
                ...
                try:
                    ...
                    if condition:
                        ...
                        co = self.coordnode.peer(key=(1, self.maproute.me), neigh=neigh)
                        ...
                        co2 = self.coordnode.peer(key = (lvl+1, newnip), neigh=neigh)
