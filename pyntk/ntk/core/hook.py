...
class Hook(object):
    ...
    def gnodes_split(self, old_node_nb, cur_node_nb):
        ...
        # gnode splitting, in fact, is the whole network that has been 
        # splitted
        ...
        #        and we are in the smaller part, rehook  and _THEN_ forward 
        #        the ETP.
        #        Is it better? Maybe not.

        # ok, our gnode of level `level' has become broken, and we are in the
        # smallest part of the two. Let's rehook. However, be sure to to 
        # rehook in a place different from the splitted gnode
