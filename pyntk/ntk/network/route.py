...
class Route:
    ...
    def _ip_route_gen_str(self, destination_ip=None, destination_bit=None,
                          protocol="ntk", table=None, net_device=None,
                          gateway=None):
        ...
        if destination_ip is not None and destionation_bit is None:
        ...
        if protocol is not None:
            ipr_str += " protocol " + str(protocol)

        # if table is provided use it
        if table is not None:
            ipr_str += " table " + str(table)

        # if net_device is provided use it
        if net_device is not None:
            ipr_str += " dev " + str(net_device)

        # if gateway is provided use it
        if gateway is not None:
            ipr_str += " via " + str(gateway)

        return ipr_str

    def _ip_route_add(self,
                      destination_ip,
                      destination_bit,
                      table,
                      net_device,
        ...
        ipr_str = "ip route add" + self._ip_route_gen_str(destination_ip,
                                                          destination_bit,
                                                          Route.protocol,
                                                          table,
                                                          net_device,
    ...
    def _ip_route_delete(self,
        ...
        # generate the ip route string
        ipr_str = "ip route delete" + self._ip_route_gen_str(destination_ip,
                                                             destination_bit,
                                                             Route.protocol,
                                                             table,
                                                             net_device,
    ...
    def _ip_route_flush(self,
                        destination_ip=None,
                        destination_bit=None,
                        table=None,
                        net_device=None,
                        gateway=None):
        ...
        # generate the ip route string
        ipr_str = "ip route flush" + self._ip_route_gen_str(destination_ip,
                                                            destination_bit,
                                                            Route.protocol,
                                                            table,
                                                            net_device,
    ...
    def _ip_route_change(self,
        ...
        # generate the ip route string
        ipr_str = "ip route change" + self._ip_route_gen_str(destination_ip,
                                                             destination_bit,
                                                             Route.protocol,
                                                             table,
                                                             net_device, gateway)
    ...
    def route_add(self,
        ...
        self._ip_route_add(destination_ip,
                           destination_bit,
                           table,
                           net_device,
                           gateway)
    ...
    def route_delete(self,
        ...
        self._ip_route_delete(destination_ip,
                              destination_bit,
                              table,
                              net_device,
                              gateway)
    ...
    def route_change(self,
        ...
        self._ip_route_change(destination_ip,
                              destination_bit,
                              table,
                              net_device,
                              gateway)
